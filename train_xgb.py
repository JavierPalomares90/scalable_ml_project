...
def main():
    ...
    xgb_model.fit_multi_class_model(model=model_verlander,x_train=X_train_verlander,y_train=Y_train_verlander,x_test=X_test_verlander,y_test=Y_test_verlander,save_location='verlander.bin')
    ...
    model_scherzer = xgb_model.get_multi_class_classifier_model()
    xgb_model.fit_multi_class_model(model=model_scherzer,x_train=X_train_scherzer,y_train=Y_train_scherzer,x_test=X_test_scherzer,y_test=Y_test_scherzer,save_location='scherzer.bin')
    ...
    model_porcello = xgb_model.get_multi_class_classifier_model()
    xgb_model.fit_multi_class_model(model=model_porcello,x_train=X_train_porcello,y_train=Y_train_porcello,x_test=X_test_porcello,y_test=Y_test_porcello,save_location='porcello.bin')
